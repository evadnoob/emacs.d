...
;;; $Header: /pack/xemacscvs/XEmacs/packages/xemacs-packages/edit-utils/recent-files.el,v 1.7 2002/05/11 05:41:23 youngs Exp $
;;;
...
If called interactively, show it in the echo area."
  (interactive)
  (let ((version "$Header: /pack/xemacscvs/XEmacs/packages/xemacs-packages/edit-utils/recent-files.el,v 1.7 2002/05/11 05:41:23 youngs Exp $"))
    (if (interactive-p)
	(message version)
      version)))

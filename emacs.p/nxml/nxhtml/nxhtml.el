...
;; Created: 2005-08-05
(defconst nxhtml:version "1.04") ;;Version:
;; Last-Updated: 2008-01-26T15:58:32+0100 Sat
;; Keywords: languages
...
(defvar nxhtml-req-features
  (let ((req-features
         '(
           ...
           (its-all-text "For It's All Text, Firefox add-on"
                         "its-all-text.el" "0.3")
...
- multiple major modes, see `define-mumamo-turn-on'
...
Also, because of a current \(normally unimportant) bug in Emacs,

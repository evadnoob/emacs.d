...
;; Fix-me: Why is not mumamo-global checking find-file-hook???
(defcustom nxhtml-auto-mode-alist
  '(
    ("\\.x?html?\\'"  . nxhtml-mumamo-turn-on)
    ("\\.x?htmlf?\\'" . nxhtml-mumamo-turn-on)
    ("\\.php\\'"      . nxhtml-mumamo-turn-on)
    ("\\.jsp\\'"      . jsp-nxhtml-mumamo-turn-on)
    ("\\.asp\\'"      . asp-nxhtml-mumamo-turn-on)
    ("\\.djhtml\\'"   . django-nxhtml-mumamo-turn-on)
    ("\\.rhtml\\'"    . eruby-nxhtml-mumamo-turn-on)
    ("\\.phps\\'"     . smarty-nxhtml-mumamo-turn-on)
    ("\\.epl\\'"      . embperl-nxhtml-mumamo-turn-on)
    ("\.lzx\\'"       . laszlo-nxml-mumamo-turn-on)

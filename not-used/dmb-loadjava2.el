...
(add-to-list 'load-path (*emacs ".emacs.x/.emacs.p/jdee/jdee/dist/jdee-2.4.1/lisp"))

;;(add-to-list 'load-path (expand-file-name "~/emacs/site/jde/lisp"))
(add-to-list 'load-path (*emacs ".emacs.x/.emacs.p/cedet-1.0.1/common"))
;;(load-file (*emacs ".emacs.x/.emacs.p/cedet-1.0.1/common/cedet.el"))
(load-file (*emacs ".emacs.x/.emacs.p/cedet-1.0pre7/common/cedet.el"))

...
(defun color-theme-sunburst ()
  ...
  (color-theme-install
   '(color-theme-sunburst
     ...
     (comint-highlight-prompt ((t (:foreground "#65b042"))))
     (buffer-menu-star-buffer ((t (:foreground "#3387cc"))))
     ...
     (mode-line ((t (:background "#111" :foreground "WhiteSmoke" :overline "white"))))
     ;;(mode-line ((t (:background "WhiteSmoke" :foreground "black" :overline "LightGray"))))
     (primary-selection ((t (:background "#222"))))
     (region ((t (:background "#4a410d"))))
     (text-cursor ((t (:background "yellow" :foreground "black"))))
     (text-cursor ((t (:foreground "#ddd"))))
